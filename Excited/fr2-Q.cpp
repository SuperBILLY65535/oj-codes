...
void bfs(const pos &begin, const int &col, const int &row)
{
    std::queue<pos> st; pos cur, tmp;
    ...
    std::printf("Poor ANGEL has to stay in the prison all his life.\n");
}
